...
from constants_FB_DP import CMDOP, CMDOP_REGISTER, PANELSIG, START_VALUE, STATUS1
...
from read_stutuses_and_message_FB_DP import read_PanelSig_one_bit, read_status1_one_bit
