...
START_VALUE = {
    'Input':      {'register': 40506, 'pre_values': 4.0, 'start_value': 5.0},
    'DeltaV':     {'register': 18066, 'pre_values': 1.0, 'start_value': 0.0},
    'Period':     {'register': 40403, 'pre_values': 90, 'start_value': 100},
    'MaxEV':      {'register': 18058, 'pre_values': 10.0, 'start_value': 20.0},
    'MinEV':      {'register': 18056, 'pre_values': 3.0, 'start_value': 4.0},
    'T01':        {'register': 17654, 'pre_values': 1, 'start_value': 0},
    'AHLim':      {'register': 18060, 'pre_values': 10.0, 'start_value': 15.0},
    'WHLim':      {'register': 18062, 'pre_values': 5.0, 'start_value': 10.0},
    'Hyst':       {'register': 18064, 'pre_values': 0.4, 'start_value': 0.5},
    'AlarmOff':   {'register': 40116, 'pre_values': True, 'start_value': False},
    'ChFlt':      {'register': 40117, 'pre_values': True, 'start_value': False},
    'ModFlt':     {'register': 40118, 'pre_values': True, 'start_value': False},
    'SensFlt':    {'register': 40119, 'pre_values': True, 'start_value': False},
    'ExtFlt':     {'register': 40120, 'pre_values': True, 'start_value': False},
    'WHLimEn':    {'register': 40121, 'pre_values': True, 'start_value': False},
    'AHLimEn':    {'register': 40122, 'pre_values': True, 'start_value': False},
    'CmdOp':      {'register': 17655, 'pre_values': 3,    'start_value': 4},
}
