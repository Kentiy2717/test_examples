...
def setup_limit_value():
    ...
    Описание:
        ...
        Уставки можно изменить путем редактирования конставт в файле(constants_FB_AP.py).
    ...
    Принцип работы:
        ...
        3. В случае возникновения ошибки при записи выводим ошибку и останавливаем работу программы.
    '''
...
def working_with_limit_value(limit_value_low_level, limit_value_mid_level, num_registr_low_level, num_registr_mid_level):
    ...
    Принцип работы:
        ...
        2. Проходим по списку coefficients циклом, на каждой итерации выполняя действия, описанные в пуктах a-e.
            a. Записываем в переменную value_for_write_low_level значение для записи.
            b. Записываем в переменную value_for_write_mid_level расчетное эталонное значение.
