...
HYSTERESIS_MID_LEVEL = 1            # гистерезис для записи на средний уровень
REGISTER_AP_LOW_LEVEL = None        # номер регистра для чтения и записи аналогового параметра (нижний уровень).
REGISTER_AP_MID_LEVEL = None        # номер регистра для чтения и записи аналогового параметра (средний уровень).
