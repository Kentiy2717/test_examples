...
STATUS_FOR_CHECK_STATUS = {
    'Обрыв':                             [None, None, None, None, None, None, None, None],
    'Минимальное аварийное значение':    [None, None, None, None, None, None, None, None],
    'Минимальное предельное значение':   [None, None, None, None, None, None, None, None],
    'Минимальное нормативное значение':  [None, None, None, None, None, None, None, None],
    'Нормальное значение':               [None, None, None, None, None, None, None, None],
    'Максимальное нормативное значение': [None, None, None, None, None, None, None, None],
    'Максимальное предельное значение':  [None, None, None, None, None, None, None, None],
    'Максимальное аварийное значение':   [None, None, None, None, None, None, None, None],
    'КЗ': 0
}
